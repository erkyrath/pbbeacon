...
/// # Curtains of blue and purple light from space.
/// 
/// pulse1=pulser:
///   maxcount = 4
...
export function render(index) {
  var valr = clamp(sum_38_vector_r[index], 0, 1)
  var valg = clamp(sum_38_vector_g[index], 0, 1)
  var valb = clamp(sum_38_vector_b[index], 0, 1)
