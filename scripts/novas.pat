...
/// # Bursts of starlights with red and orange coronas.
/// 
/// drop1=pulser:
///   maxcount = 6
...
export function render(index) {
  var valr = clamp(max_28_vector_r[index], 0, 1)
  var valg = clamp(max_28_vector_g[index], 0, 1)
  var valb = clamp(max_28_vector_b[index], 0, 1)
